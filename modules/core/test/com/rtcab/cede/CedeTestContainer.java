...
public class CedeTestContainer extends TestContainer {

    public CedeTestContainer() {
        super();
    ...
    public static class Common extends CedeTestContainer {

        public static final CedeTestContainer.Common INSTANCE = new CedeTestContainer.Common();
